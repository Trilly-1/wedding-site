...
export default function EnvelopeIntro({ onEnter }) {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .envelope-open {
        animation: flap-open 1s ease forwards;
        transform-origin: top;
      }

      .letter-rise {
        animation: letter-rise 1s ease forwards;
      }

      .cards-enter {
        animation: cards-fly-out 1s ease forwards;
      }
    `
  ...
  return (
    <div
      className={`relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#1b1410] via-[#261b15] to-[#120d0a] transition-all duration-700 ${
        leaving ? 'scene-leave' : ''
      }`}
    >
      {/* Background Glow */}
      ...
      {!cardsRising && (
        <>
              ...
              {isOpening && (
                <div className="absolute left-1/2 bottom-[70px] -translate-x-1/2 w-[260px] h-[170px] rounded-2xl bg-gradient-to-br from-white to-[#f9f3ea] shadow-2xl z-10 letter-rise border border-[#E7D0A5]">
                  ...
                  <div className="h-full flex flex-col items-center justify-center text-center px-6">
                    ...
                    <p className="text-[#C9A05A] italic text-2xl my-1">
                      &
                    </p>
              ...
              <div className="absolute inset-0 rounded-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.35)] border border-[#D6B77A]/20 bg-gradient-to-br from-[#F6E5C7] via-[#E8D2AA] to-[#DDBA7B]">
                ...
                <div
                  ...
                  style={{
                    ...
                    background:
                      'linear-gradient(145deg, #E8D5B7 0%, #DDBE8A 100%)',
                  }}
                />

                {/* Left Fold */}
                <div
                  className="absolute bottom-0 left-0 w-1/2 h-[65%]"
                  style={{
                    clipPath: 'polygon(0 0, 100% 50%, 100% 100%, 0 100%)',
                    background:
                      'linear-gradient(145deg, #EAD7B8, #D9B989)',
                  }}
                />

                {/* Right Fold */}
                <div
                  className="absolute bottom-0 right-0 w-1/2 h-[65%]"
                  style={{
                ...
                <div
                  ...
                  style={{
                    ...
                    background:
                      'linear-gradient(145deg, #E2C79B, #D3AF76)',
                  }}
                />
                ...
                {!isOpening && (
                  <div className="absolute left-1/2 top-[48%] -translate-x-1/2 -translate-y-1/2 z-30">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#B94A6B] to-[#8B2D4B] flex items-center justify-center shadow-2xl animate-pulse-glow">
                      ...
                      <span className="text-white text-2xl font-serif tracking-wider animate-shine">
                        T&H
                      </span>
                    </div>
                  </div>
          ...
          {!isOpening && (
            ...
            >
              <p
                className="text-[#D4B06A] text-lg tracking-[0.35em] font-semibold"
                style={{
                  animation: 'super-shine 1.8s ease-in-out infinite',
                }}
              >
                CLICK TO OPEN
              </p>
      ...
      {cardsRising && (
        <>
          ...
          <div className="hidden lg:flex items-center justify-center gap-8 px-10 w-full max-w-7xl mx-auto cards-enter">
            ...
            {/* LEFT CARD */}
            <div
              className="w-72 h-[26rem] rounded-3xl p-8 shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:rotate-[-3deg]"
              style={{
                background:
                  'linear-gradient(135deg, #FFF8F0, #FBE8ED)',
              }}
            >
              <div className="text-center h-full flex flex-col justify-center">
                <p className="text-[#C9668F] text-lg tracking-widest mb-2">
                  ❀ ✿ ❀
                </p>

                <p className="text-[0.65rem] tracking-[0.25em] uppercase text-[#C9A05A]">
                  — with joy —
                </p>

                <h2 className="text-4xl text-[#A2526A] my-4 font-serif">
                  You're Invited
                </h2>
            ...
            {/* CENTER CARD */}
            <div
              className="relative w-80 h-[30rem] rounded-[2rem] p-10 shadow-[0_25px_60px_rgba(0,0,0,0.25)] z-10 border border-white/30 transition-all duration-500 hover:-translate-y-3"
              style={{
                background:
                  'linear-gradient(135deg, #FDFAF4, #F5EFE0)',
              }}
            >
              <div className="text-center h-full flex flex-col justify-center">
                <p className="text-[0.65rem] tracking-[0.35em] uppercase text-[#C9A05A] mb-3">
                  The wedding of
                </p>

                <h2 className="text-5xl text-[#A2526A] leading-tight font-serif">
                  Timothy
                </h2>

                <p className="italic text-3xl text-[#C9A05A] my-2">
                  &
                </p>
                ...
                <p className="italic text-sm text-gray-600 leading-relaxed px-2">
                  What started as a simple friendship gradually became something truly special.
                </p>
              </div>
            </div>
            ...
            >
              <div className="text-center h-full flex flex-col justify-center items-center gap-5">
                ...
                <button
                  ...
                  className="mt-4 px-8 py-3 bg-[#A2526A] text-white text-sm rounded-full hover:scale-105 transition-all duration-300 shadow-lg"
                >
                  Continue
                </button>
              </div>
          ...
          {/* MOBILE */}
          <div className="lg:hidden flex flex-col gap-6 px-4 py-10 w-full items-center cards-enter">

            {/* MOBILE CARD 1 */}
            <div className="w-full max-w-xs rounded-3xl p-6 shadow-lg bg-gradient-to-br from-[#FFF8F0] to-[#FBE8ED]">
              <div className="text-center">
                <h2 className="text-3xl text-[#A2526A] font-serif">
                  You're Invited
                </h2>
            ...
            {/* MOBILE CARD 2 */}
            <div className="w-full max-w-xs rounded-3xl p-6 shadow-lg bg-gradient-to-br from-[#FDFAF4] to-[#F5EFE0]">
              <div className="text-center">
                <p className="uppercase tracking-[0.3em] text-xs text-[#C9A05A] mb-2">
                  The wedding of
                </p>

                <h2 className="text-4xl text-[#A2526A] font-serif">
                  Timothy
                </h2>

                <p className="italic text-2xl text-[#C9A05A] my-1">
                  &
                </p>
            ...
            <div className="w-full max-w-xs rounded-3xl p-6 shadow-lg bg-gradient-to-br from-[#FFF8F0] to-[#FBE8ED]">
              <div className="text-center flex flex-col items-center gap-4">
                ...
                <button
                  onClick={handleViewMore}
                  className="w-full px-6 py-3 bg-[#A2526A] text-white rounded-full shadow-lg"
                >
                  Continue
                </button>
              </div>
